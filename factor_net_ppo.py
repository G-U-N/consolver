...
class FactorNetPPO(nn.Module):
    def __init__(self, embedding_dim=1024, hidden_dim=256, num_actions=161, 
                 order_dim=4, scaler_dim=2, use_conv=False, 
        ...
        self.action_dims = self.order_dim + self.scaler_dim - 1
        ...
        first_order_values = torch.linspace(0, 2, num_actions)
