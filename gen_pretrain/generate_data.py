...
# to extract image-caption pairs from COCO-style json file, not used
...
def read_prompts(file_path):
    ...
    if not file_path:
        file_path = "part-00000-cad4a140-cebd-46fa-b874-e8968f93e32e-c000.snappy.parquet"
...
if __name__ == "__main__":
    ...
    prompts, img_paths = read_prompts(validation_path=args.validation_path)
